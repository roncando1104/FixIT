...
//public class PendingViewHolders extends RecyclerView.ViewHolder implements View.OnClickListener {
    public class PendingViewHolders extends RecyclerView.ViewHolder{


    TextView consumerId, consumerName, consumerPhone, consumerServiceRequest, houseLocation, dateSched, timeRequest, payment, consumerNote,   providerId, providerName, providerAge, providerPhone;


    public PendingViewHolders(View itemView) {
        super(itemView);
     //   itemView.setOnClickListener(this);
      ...
      //  houseLocation = (TextView) itemView.findViewById(R.id.houseLocation);
        ...
        providerAge = (TextView) itemView.findViewById(R.id.providerAge);
